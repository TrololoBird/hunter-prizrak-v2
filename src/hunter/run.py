...
OUTCOME_LABEL = {
    ...
    # Тот же класс, пойман аудитом 2026-08-25: UNMEASURABLE заведён 2026-08-23 в
    # OutcomeKind без подписи здесь, и `hunter run` падал KeyError'ом ПОСЛЕ полного
    # расчёта, теряя отчёт целиком.
