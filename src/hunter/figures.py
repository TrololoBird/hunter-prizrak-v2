...
def pennant(
    ...
    вымпел и есть сужение, поэтому свой ряд молчал у 43% сужений. Разбор против контроля
    «та же цепочка на 200 баров раньше»: сходимость 65.8% против 20.4%, и там же тренд
    ЕСТЬ у 61.1%. То есть сходимость начинается РАНЬШЕ первой принятой точки границы, и
