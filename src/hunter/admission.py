...
DEFINED_FROM_BARS: dict[str, int] = {
    ...
    "rsi14": 15,
    "adx14": 28,
    # MACD = ema12 - ema26, определён там же, где ema26 (замер: первое значение
    # ema(26) на баре 25). Прежние 34 относились к polars_talib.macd, который
    # выравнивал выдачу по сигнальной линии и был внутренне противоречив.
    "macd": 26,
    "ema200": 200,
}
