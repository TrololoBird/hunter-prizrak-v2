...
про внешний бар не говорила ничего, хотя он встречается у 3.06% свингов (замер по 7.6 млн
баров; на 1Н 5.52%).
...
с юнит-тестом), 17 схлопывают в одну. Мы следуем автору выбранного определения — это
основание, а не большинство голосов.
