...
ЧИСТЫЙ МОДУЛЬ (§10.3): часы, сеть и глобальное состояние не трогаются.
  ...
  стр. 24  цель: «другой сопоставимый уровень того же ТФ, либо уровень 1Д тф, если он
           ближайший. Уровни ТФ-1 могут быть взяты как ПРОМЕЖУТОЧНЫЕ цели с небольшими
           тейками. Уровни ТФ-2 (15м и ниже) обычно НЕ берутся в расчёт»
...
class Setup(BaseModel):
    ...
    """Стоповый объём или лой ТФ-1 в 2-5% от границы — «идеально прятать за них» (стр. 18).
