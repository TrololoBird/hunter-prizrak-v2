...
⚠ С 2026-08-23 к охвату ПРИБАВЛЯЕТСЯ прогрев (700 баров, `run.seed_warmup`), а не
берётся строжайшее из двух: 52 540 баров на 5м, 880 на 1Д. Прежнее `max(прогрев, охват)`
означало, что перед левым краем горизонта прогрева не остаётся вовсе, и била эта
арифметика по старшим ТФ — на 1Д ряд из 201 бара давал ema200 ровно на ОДНОМ баре из 180.
Разбор и замеры — в докстроке `bars.bars_needed`.
