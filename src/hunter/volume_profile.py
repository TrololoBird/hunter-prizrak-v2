...
по источникам (указание владельца 2026-08-09), и вот их сходимость:
  ...
  N. Число строк остаётся вопросом к живому TradingView автора (открытый вопрос №2 в
  .claude/rules/open-method-questions.md) и замером НЕ решается.
"""
...
class RowSize(StrEnum):
    ...
    а решение о переключении — владельца.
    ⚠ Зонд её цены (docs/audit/probes/probe_tv_row_size_2026-08-10.py) УДАЛЁН 2026-08-19
    приказом владельца; цена этой гипотезы сейчас НЕ ЗАМЕРЕНА.
    """
