...
def _one_level_per_range(
    ...
    ⚠ ЦЕНА ВЫБОРА НАЗВАНА: охват падает с 6 линий из 17 до 5, промах растёт с 0.15% до
    0.41%. Взято оно потому, что не схлопывает сторону над ценой, и потому, что число
    уровней (17) совпало с числом линий автора на том же кадре. Выборка — ОДИН символ
    в ОДИН момент; на большем числе кадров вывод может смениться.
