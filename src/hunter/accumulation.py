...
Механика, взятая дословно:
  ...
  стр. 18  при проколе за границу «стоп всегда ставится за этот прокол»
           ⚠ Исправлено 2026-08-07 по обзору docs/audit/accumulation-projects-2026-08-07.md.
           Раньше здесь стояло «прокол за границу — расширение базы, а не слом», и это
           страницу искажало: курс говорит, что база МОЖЕТ расшириться и цена дальше может
           ходить в расширенном диапазоне. Про заморозку границы курс не говорит вовсе —
           она наша, и её опора ниже, в BoundaryZone: стр. 13 плюс замер.
