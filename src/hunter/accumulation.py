...
⚠⚠ ОТКРЫТЫЙ ДЕФЕКТ, НАЙДЕННЫЙ 2026-08-20 И НЕ ЗАКРЫТЫЙ: НА 1Н КОРОБКИ АБСУРДНЫ.
...
Порога высоты я не ввожу: курс его не даёт нигде, а стр. 30 наоборот предупреждает, что
«накопление очень большое ТФ 1Д-1Н-1М» — штатный случай, для которого есть своё правило
(«закуп всегда стоит делить на зону и на уровень»). Отличить «очень большое накопление»
от «всей истории актива» нужно источником, а не числом, и такого источника пока не
найдено. Пункт числится открытым.
"""
