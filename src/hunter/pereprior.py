...
def _detect_side(
    ...
    for i in range(1, len(others)):
        ...
        #
        # Внешний бар даёт хай и лой ОДНОВРЕМЕННО — замер на 7.6 млн баров: 3.06% свингов,
        # на 1Н 5.52% (docs/audit/boundary-point-same-bar-2026-08-17.md). Такой лой стоит
