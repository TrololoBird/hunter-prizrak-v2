...
6. **Термины корпуса, которых нет ни в курсе, ни в коде, только перечислены:**
   база-переприор, поджатие, живой уровень, размазанный уровень, канальная структура,
   зона интереса, внешняя ликвидность. Их разбор — отдельная работа.
