...
| 8 | уровни BUY/SELL | `src/hunter/levels.py` | support resistance detection, price level clustering, level strength scoring, supply demand zones, order block detection | фазы 1–3 пройдены 2026-08-09 (16 реализаций), фазы 4–6 (гипотезы, замер, решение) НЕ начаты | [levels-projects-2026-08-09.md](levels-projects-2026-08-09.md): по трём развилкам мы в меньшинстве, М-08 подтверждён выборкой, три гипотезы ждут фазы 4 |
